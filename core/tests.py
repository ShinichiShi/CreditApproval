...
class LoanAPITestCase(APITestCase):
    ...
    def test_register_customer_success(self):
        ...
        self.assertEqual(response.data["approved_limit"], 1400000)  # 36 * 40000 = 1,440,000 rounded to 1,400,000
    ...
    def test_register_customer_with_monthly_income_field(self):
        ...
        self.assertEqual(response.data["approved_limit"], 1600000)  # 36 * 45000 = 1,620,000 rounded to 1,600,000
    ...
    def test_check_eligibility_high_score_approval(self):
        ...
        self.assertIn("approval", response.data)  # May be True or False depending on scoring
    ...
    def test_view_customer_loans_multiple_loans(self):
        ...
        response = self.client.get(f"/view-loans/{self.high_loan_customer.customer_id}/")
    ...
    def test_full_loan_workflow(self):
        ...
        # 2. Check eligibility
        eligibility_response = self.client.post("/check-eligibility/", {
        ...
        if eligibility_response.data["approval"]:
            create_response = self.client.post("/create-loan/", {
                "customer_id": customer_id,
                "loan_amount": "100000",
                "interest_rate": "12",
                "tenure": "12"
    ...
    def test_concurrent_loan_applications(self):
        ...
        # First loan
        response1 = self.client.post("/create-loan/", {
            "customer_id": self.customer.customer_id,
            "loan_amount": "30000",
            "interest_rate": "12",
            "tenure": "12"
        ...
        response2 = self.client.post("/create-loan/", {
            "customer_id": self.customer.customer_id,
            "loan_amount": "40000",
            "interest_rate": "12",
            "tenure": "12"
